...
from app.routers import openai, transcriptions, models, health, admin, websocket, account, tts, voxtral
...
app.include_router(voxtral.router, prefix="/api", tags=["Voxtral Realtime"])
