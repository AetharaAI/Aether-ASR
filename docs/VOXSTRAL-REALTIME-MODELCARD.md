...
For more details, see our:
    ...
    Demo
    Technical report
    vLLM's blog on streaming input
...
We have added two simple example files that allow you to:
    ...
    Stream audio files
    Simple gradio live transcription demo
...
Voxtral Realtime integrations in:
    ...
    mlx-audio framework - thanks Shreyas Karnik
    MLX - thanks Awni Hannun
    Rust - thanks TrevorS
